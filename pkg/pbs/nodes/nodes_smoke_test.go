...
import (
	...
	"github.com/fivetwenty-io/proxmox-apiclient-go/v3/pkg/pbs/nodes"
)
...
func TestGenerated_Nodes_Methods(t *testing.T) {
	...
	t.Run("CreateCertificatesAcmeCertificate", func(t *testing.T) {
		...
		err := svc.CreateCertificatesAcmeCertificate(ctx, "sample-node", &nodes.CreateCertificatesAcmeCertificateParams{})
		if err != nil {
		...
		var nilCtx context.Context
		if err := svc.CreateCertificatesAcmeCertificate(nilCtx, "sample-node", &nodes.CreateCertificatesAcmeCertificateParams{}); err == nil {
	...
	t.Run("UpdateCertificatesAcmeCertificate", func(t *testing.T) {
		...
		err := svc.UpdateCertificatesAcmeCertificate(ctx, "sample-node", &nodes.UpdateCertificatesAcmeCertificateParams{})
		if err != nil {
		...
		var nilCtx context.Context
		if err := svc.UpdateCertificatesAcmeCertificate(nilCtx, "sample-node", &nodes.UpdateCertificatesAcmeCertificateParams{}); err == nil {
	...
	t.Run("ListDisks", func(t *testing.T) {
		...
		err := svc.ListDisks(ctx, "sample-node")
		if err != nil {
		...
		var nilCtx context.Context
		if err := svc.ListDisks(nilCtx, "sample-node"); err == nil {
	...
	t.Run("CreateDisksDirectory", func(t *testing.T) {
		...
		resp, err := svc.CreateDisksDirectory(ctx, "sample-node", &nodes.CreateDisksDirectoryParams{Disk: "sample-disk", Name: "sample-name"})
		if err != nil {
		...
		var nilCtx context.Context
		if _, err := svc.CreateDisksDirectory(nilCtx, "sample-node", &nodes.CreateDisksDirectoryParams{Disk: "sample-disk", Name: "sample-name"}); err == nil {
	...
	t.Run("DeleteDisksDirectory", func(t *testing.T) {
		...
		err := svc.DeleteDisksDirectory(ctx, "sample-node", "sample-name")
		if err != nil {
		...
		var nilCtx context.Context
		if err := svc.DeleteDisksDirectory(nilCtx, "sample-node", "sample-name"); err == nil {
	...
	t.Run("ListIdentity", func(t *testing.T) {
		...
		resp, err := svc.ListIdentity(ctx, "sample-node")
		if err != nil {
			t.Fatalf("ListIdentity: unexpected error: %v", err)
		}
		if resp == nil {
			t.Fatal("ListIdentity: response is nil")
		}

		got := harness.snapshot()
		assertRequestLine(t, got, "GET", "/api2/json/nodes/sample-node/identity")

		var nilCtx context.Context
		if _, err := svc.ListIdentity(nilCtx, "sample-node"); err == nil {
			t.Errorf("ListIdentity: expected error for nil context, got nil")
		}
	})
	...
	t.Run("UpdateNetwork", func(t *testing.T) {
		...
		err := svc.UpdateNetwork(ctx, "sample-node")
		if err != nil {
		...
		var nilCtx context.Context
		if err := svc.UpdateNetwork(nilCtx, "sample-node"); err == nil {
	...
	t.Run("ListRrd", func(t *testing.T) {
		...
		err := svc.ListRrd(ctx, "sample-node", &nodes.ListRrdParams{Cf: "sample-cf", Timeframe: "sample-timeframe"})
		if err != nil {
		...
		var nilCtx context.Context
		if err := svc.ListRrd(nilCtx, "sample-node", &nodes.ListRrdParams{Cf: "sample-cf", Timeframe: "sample-timeframe"}); err == nil {
	...
	t.Run("GetServices", func(t *testing.T) {
		...
		err := svc.GetServices(ctx, "sample-node", "sample-service")
		if err != nil {
		...
		var nilCtx context.Context
		if err := svc.GetServices(nilCtx, "sample-node", "sample-service"); err == nil {
	...
	t.Run("CreateServicesReload", func(t *testing.T) {
		...
		err := svc.CreateServicesReload(ctx, "sample-node", "sample-service")
		if err != nil {
		...
		var nilCtx context.Context
		if err := svc.CreateServicesReload(nilCtx, "sample-node", "sample-service"); err == nil {
	...
	t.Run("CreateServicesRestart", func(t *testing.T) {
		...
		err := svc.CreateServicesRestart(ctx, "sample-node", "sample-service")
		if err != nil {
		...
		var nilCtx context.Context
		if err := svc.CreateServicesRestart(nilCtx, "sample-node", "sample-service"); err == nil {
	...
	t.Run("CreateServicesStart", func(t *testing.T) {
		...
		err := svc.CreateServicesStart(ctx, "sample-node", "sample-service")
		if err != nil {
		...
		var nilCtx context.Context
		if err := svc.CreateServicesStart(nilCtx, "sample-node", "sample-service"); err == nil {
	...
	t.Run("ListServicesState", func(t *testing.T) {
		...
		err := svc.ListServicesState(ctx, "sample-node", "sample-service")
		if err != nil {
		...
		var nilCtx context.Context
		if err := svc.ListServicesState(nilCtx, "sample-node", "sample-service"); err == nil {
	...
	t.Run("CreateServicesStop", func(t *testing.T) {
		...
		err := svc.CreateServicesStop(ctx, "sample-node", "sample-service")
		if err != nil {
		...
		var nilCtx context.Context
		if err := svc.CreateServicesStop(nilCtx, "sample-node", "sample-service"); err == nil {
	...
	t.Run("ListTasksLog", func(t *testing.T) {
		...
		err := svc.ListTasksLog(ctx, "sample-node", "sample-upid", &nodes.ListTasksLogParams{})
		if err != nil {
		...
		var nilCtx context.Context
		if err := svc.ListTasksLog(nilCtx, "sample-node", "sample-upid", &nodes.ListTasksLogParams{}); err == nil {
