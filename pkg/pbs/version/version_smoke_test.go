...
func TestGenerated_Version_Methods(t *testing.T) {
	...
	t.Run("Get", func(t *testing.T) {
		...
		assertRequestLine(t, got, "GET", "/api2/json/version")

		var nilCtx context.Context
		if _, err := svc.Get(nilCtx); err == nil {
			t.Errorf("Get: expected error for nil context, got nil")
		}
	})
	t.Run("ErrorPath_GET", func(t *testing.T) {
		...
		_, err := svc.Get(ctx)
		if err == nil {
			t.Fatalf("Get: expected error on 500 response, got nil")
		}
	})
}
